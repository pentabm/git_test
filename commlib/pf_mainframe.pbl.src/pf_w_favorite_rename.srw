$PBExportHeader$pf_w_favorite_rename.srw
$PBExportComments$사용자별 즐겨찾기를 이름 변경하는 화면입니다
forward
...
if ll_cnter < 1 then
	messagebox('알림', "해당 프로그램은 즐겨찾기로 등록되어 있지 않습니다.")
...
//			return
//		case else
			messagebox('알림', "즐겨찾기 변경 실패![" + string(dw_favor.istr_dberror.sqldbcode) + "]~r~n" + dw_favor.istr_dberror.sqlerrtext)	
			closewithreturn(parent, 'Cancel')
			return
//	end choose
end if
...
integer width = 1723
long textcolor = 20132659
string text = "이 즐겨찾기의 이름과 위치를 변경할 수 있습니다."
end type
